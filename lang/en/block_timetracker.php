...
$string['timetracker:manageid'] = 'Manage the id of the worker'; 
$string['timetracker:viewonly'] = 'User can view all data, but cannot make changes';
...
$string['remaining'] = 'Approx Remaining: ';
