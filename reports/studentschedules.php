...
if(($handle = fopen("../testfile.csv", "r")) !== FALSE){
    while(($data = fgetcsv($handle, 1000, ",")) !== FALSE){
        ...
        $starttime = $data[3];
        $endtime = $data[4];
        //echo "Email: $email Course Name: $coursename Days: $days_string Start: $starttime End: $endtime <br />";
                    ...
                    if(sizeof($conflicts) > 0){
                        foreach($conflicts as $conflict){
                            echo "$worker->lastname,$worker->firstname,".
                                ...
                                $conflict->display.','.$course->shortname.','.$supervisor."<br />\n";
                        }
                    } else {
                        //echo "No conflict <br />\n";
                    }
